...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-center z-10">
      <div className="w-1/2 h-12 border border-black/5 bg-black/20 shadow-lg backdrop-filter backdrop-blur-3xl rounded-full px-6 py-3 flex items-center justify-between text-[#efefef] fixed z-50 top-4">
        <div>
