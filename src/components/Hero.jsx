...
const Hero = () => {
  ...
  return (
    <div className="relative flex h-screen gap-4 overflow-hidden bg-slate-950 py-4">
      {/* Blobs Behind */}
      <div className="absolute top-[-220px] right-[-220px] w-[35rem] h-[35rem] animate-float z-0">
        <div className="w-full h-full p-[6px] rounded-[60%_40%_70%_30%/40%_60%_30%_70%] animate-blob 
      ...
      <div className="absolute bottom-[-220px] left-[-220px] w-[35rem] h-[35rem] animate-float-delayed z-0">
        <div className="w-full h-full p-[6px] rounded-[70%_30%_60%_40%/30%_70%_40%_60%] animate-blob-delayed 
      ...
      {/* Hero Content */}
      <div className="w-1/2 flex flex-col justify-center gap-10 px-10 relative z-20">
        <h1 className="text-7xl font-poppins text-[#f8f7f3] font-semibold">
          Sarthak Wadegaonkar
        </h1>
        <div className="flex justify-end">
      ...
      <div className="w-1/2 flex items-center justify-start relative z-20">
        <div className="absolute w-min h-min flex flex-col z-20 right-12 top-4">
          <p className="z-50 w-min h-min text-[#f8f7f3] font-cursive text-2xl">
            Résumé
          </p>
        ...
        <div className="w-4/5 h-3/4 relative">
          ...
          <div className="w-24 h-24 absolute z-10 -right-10 -top-10 rounded-full flex justify-center items-center">
            <button
              onClick={() => setShowResume(true)}
              className="w-20 h-20 rounded-full hover:scale-110 transition ease-in-out duration-100 text-[#f8f7f3] flex items-center justify-center bg-black/30 backdrop-blur-3xl border border-black/5"
            >
              <img src={ResumeImg} alt="" className="w-10 h-auto" />
            </button>
          </div>
          <div className="flex absolute bg-[#020617] h-52 w-16 bottom-0 rounded-bl-3xl rounded-tr-3xl z-10"></div>
        </div>
      </div>
