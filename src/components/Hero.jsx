    ...
    <div className="flex h-screen gap-4">
      <div className="w-1/2 flex flex-col justify-center gap-10 px-10">
        ...
        <div className="flex justify-end">
          <p className="text-lg font-inter text-[#f8f7f3]">
            Developing till my coffee arrives.
          </p>
        </div>
        <Socials />
      ...
      <div className="w-1/2 flex items-center justify-start">
        <div className="w-4/5 h-3/4 relative">
          ...
          <div className="flex w-full h-full bg-black/30 backdrop-filter backdrop-blur-3xl rounded-3xl z-0 absolute items-end justify-end">
